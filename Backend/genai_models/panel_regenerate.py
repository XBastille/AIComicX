...
def generate_panel_image(prompt, width, height, guidance_scale, inference_steps, seed):
    ...
    try:
        ...
        negative_prompt = "photorealistic, realistic, photo, 3d render, photography, photographic, hyperrealistic, low quality, bad anatomy, worst quality, low resolution, text, words, speech, dialogue, speech bubble, bubble, blurry, distorted"
