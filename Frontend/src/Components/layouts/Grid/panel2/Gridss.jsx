...
function Gridss({ onPanelClick, images }) {
            ...
            <div style={styles.container}>
                <div style={styles.inner}>
                    <div style={{
                        ...
                        <div style={{ ...styles.box, width: `${zoom * 470}px`, height: `${zoom * 300}` }} onClick={() => onPanelClick?.(1)}>
                            <img src={images[0]} alt="Comic_Space_1" style={{ maxWidth: "100%", maxHeight: "100%", objectFit: "contain" }} />
                        </div>
                        <div style={{ ...styles.box, width: `${zoom * 470}px`, height: `${zoom * 300}` }} onClick={() => onPanelClick?.(2)}>
