...
function ChoosePage() {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(animation, 50);
        ...
        return () => {
            ...
            gsap.killTweensOf([box1Ref.current, box2Ref.current, box3Ref.current, headingRef.current, energyBeamRef.current, glitchLayerRef.current]);
        };
    }, [isLoaded, isSignedIn]);
